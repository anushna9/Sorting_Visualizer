...
bool controls()
{
    cout <<"WARNING: Giving repetitive commands may cause latency and the visualizer may behave unexpectedly. Please give a new command only after the current command's execution is done.\n\n"
         ...
         <<"    Press 1 Selection Sort Algorithm.\n"
         <<"    Press 2 Insertion Sort Algorithm.\n"
         <<"    Press 3 Bubble Sort Algorithm.\n"
         <<"    Press 4 Merge Sort Algorithm.\n"
         <<"    Press 5 Quick Sort Algorithm.\n"
         <<"    Press 6 Heap Sort Algorithm.\n"
...
void intro()
{
    cout<<"==============================Sorting Visualizer==============================\n\n"
        ...
        <<"The sorting algorithms are : Selection Sort, Insertion Sort, Bubble Sort, Merge Sort, Quick Sort and Heap Sort.\n"
        <<"The list size is fixed to 120 elements. You can select any type of sorting algorithm to call on the list . Here, all the elements will be sorted in ascending order.\n"
